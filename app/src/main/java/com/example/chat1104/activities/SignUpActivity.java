...
import com.example.chat1104.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    /**
     * add a user to the firestore data base if they entered all fields correctly
     */
    private void SignUp(){
        //check loading
        loading(true);
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    prefrenceManager.putString(Constants.KEY_IMAGE,encodeImage);
    ...
    /**
     * encoding an image and compress it to a bitmap so we can convert it into a string
     * and save it
     * @param bitmap
     * @return an image encoded into a string
     */
    private String encodeImage(Bitmap bitmap){
        int previousWidth = 150;

        int previewHeight = bitmap.getHeight()*previousWidth / bitmap.getWidth();

        Bitmap prevBitmap = Bitmap.createScaledBitmap(bitmap,previousWidth,previewHeight,false);
    ...
    /**
     * check to make sure a user correctly input:
     * an image
     * a name
     * a valid email
     * two matching passwords
     * @return true if user input correct information in all fields
     */
